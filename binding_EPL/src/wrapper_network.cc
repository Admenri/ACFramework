...
DLL_EXPORTS(CreateRequest, BOOL)(DWORD* target) {
  AcfRefPtr<AcfRequest> lpObj = AcfEnvironment::CreateRequest();
...
DLL_EXPORTS(CreatePostData, BOOL)(DWORD* target) {
  AcfRefPtr<AcfPostData> lpObj = AcfEnvironment::CreatePostData();
...
DLL_EXPORTS(CreatePostDataElements, BOOL)(DWORD* target) {
  AcfRefPtr<AcfPostDataElement> lpObj = AcfEnvironment::CreatePostDataElement();
...
DLL_EXPORTS(CreateResponse, BOOL)(DWORD* target) {
  AcfRefPtr<AcfResponse> lpObj = AcfEnvironment::CreateResponse();
